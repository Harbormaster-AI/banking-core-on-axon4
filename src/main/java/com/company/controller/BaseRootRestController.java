...
public class BaseRootRestController extends BaseSpringRestController {
    ...
    public ResponseEntity<String> root() {
        return ResponseEntity.ok("bankingeventsourced is running.");
    }
    ...
    protected static final String BLUEPRINT             = "Axon4-Framework-Server";
    protected static final String BLUEPRINT_VERSION     = "1.2";
