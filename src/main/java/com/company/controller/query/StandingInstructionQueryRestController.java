...
public class StandingInstructionQueryRestController extends BaseSpringRestController {
    ...
    public StandingInstruction load( @RequestParam(required=true) UUID standingInstructionId ) {
    	...
    	try {  
    		entity = StandingInstructionBusinessDelegate.getStandingInstructionInstance().getStandingInstruction( new StandingInstructionFetchOneSummary( standingInstructionId ) );
        }
        catch( Throwable exc ) {
